...
import DemoAuditSuggestionCard from './DemoAuditSuggestionCard.vue';
...
<style scoped>
.demo-suggestion-panel h2,
.demo-suggestion-panel p {
  margin: 0;
}
...
.demo-suggestion-panel code {
  color: var(--text-primary);
  font-weight: 850;
}

.demo-suggestion-panel__grid {
  display: grid;
